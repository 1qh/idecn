...
const TextAnnotationHostLazy = lazy(async () => ({ default: (await import('./text-annotation-host')).TextAnnotationHost }))
const TextAnnotationHost = (props: TextAnnotationHostProps) => (
  <Suspense fallback={null}>
    <TextAnnotationHostLazy {...props} />
  </Suspense>
)
const GridEditorHostLazy = lazy(async () => ({ default: (await import('./grid-editor-host')).GridEditorHost }))
